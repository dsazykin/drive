...
abstract public class Car {
    ...
    private final float reverseConstant;

    private final float wheelBase;
    private final float trackWidth;
    private final float cgHeight;
    private final float mass;

    private boolean accelerating = false;
    private boolean breaking = false;

    protected Car(AssetManager assetManager, PhysicsSpace physicsSpace, Vehicle car, float maxSpeed, float accelerationConstant,
                  float maxReverse, float reverseConstant, float wheelBase, float trackWidth,
